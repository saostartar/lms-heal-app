      ...
      <div className="min-h-screen flex flex-col bg-gray-50">
        ...
        <main className="flex-grow container mx-auto px-4 py-12">
          <div className="flex flex-col items-center justify-center py-20">
            ...
            <p className="mt-4 text-gray-600 font-medium">Loading discussion...</p>
          </div>
        </main>
        <Footer />
      </div>
        ...
        <main className="flex-grow container mx-auto px-4 py-12 max-w-5xl">
          <div className="card-glass border-red-200 bg-red-50/80 mb-8">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-red-800 mb-0">Error</h3>
                <p className="text-red-700 mt-1">{error || 'Topic not found'}</p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 py-8 max-w-5xl">
          <div className="flex items-center gap-2 text-white/80 mb-3">
            ...
            <Link href={`/forum/categories/${topic.categoryId}`} className="hover:text-white transition-colors">
              {topic.ForumCategory?.title || 'Category'}
            </Link>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="text-sm">
              <span className="text-white/90">Started by</span>{' '}
      ...
      <main className="flex-grow container mx-auto px-4 py-8 max-w-5xl">
        ...
        <div className="mb-8">
          <div className="flex justify-between items-center mb-6">
            <div className="flex items-center gap-2">
              <h2 className="text-2xl font-bold text-gray-800 m-0">Replies</h2>
        ...
        {isAuthenticated && !topic.isLocked ? (
          <div className="card-glass bg-white border-primary-100 shadow-lg" id="reply-form">
            <h3 className="text-xl font-bold text-primary-700 mb-4">Post a Reply</h3>
          ...
          <div className="card-glass bg-yellow-50/80 border-yellow-200">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-yellow-800 mb-0">Topic Locked</h3>
                <p className="text-yellow-700 mt-1">This topic is locked and no longer accepts replies.</p>
              </div>
            </div>
          </div>
        ) : (
          <div className="card-glass bg-white text-center">
            <div className="flex flex-col items-center">
              ...
              <p className="text-gray-600 mb-6">You need to be logged in to reply to this topic.</p>
              <Link 
