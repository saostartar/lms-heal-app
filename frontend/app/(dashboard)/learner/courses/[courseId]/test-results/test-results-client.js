...
export default function TestResultsClient({
    ...
    const fetchData = async () => {
      try {
        ...
        const { data } = await axios.get(
          `/api/analytics/course/${courseId}/test-comparison`
        );
  ...
  if (loading) {
    return (
      <div className="min-h-[80vh] flex flex-col justify-center items-center bg-gradient-to-br from-indigo-50 to-purple-50 p-8 rounded-3xl">
        ...
        <p className="mt-6 text-indigo-800 font-medium animate-pulse">
    ...
    return (
      <div className="min-h-[50vh] flex flex-col items-center justify-center p-8 bg-red-50 rounded-3xl shadow-lg border border-red-100">
        ...
        <Link
          ...
          className="px-6 py-3 bg-white text-red-600 rounded-full shadow-md hover:shadow-lg transition-all duration-300 font-medium">
          Return to Course
        </Link>
      </div>
    );
  ...
  const preTestOffset =
    preTestCircumference - (preTestScore / 100) * preTestCircumference;
  const postTestOffset =
    postTestCircumference - (postTestScore / 100) * postTestCircumference;

  // Calculate improved/declined questions count
  const improvedCount = comparison.comparison.questionComparison.filter(
    (q) => q.improved
  ).length;
  const declinedCount = comparison.comparison.questionComparison.filter(
    (q) => q.declined
  ).length;
  const unchangedCount =
    comparison.comparison.questionComparison.length -
    improvedCount -
    declinedCount;
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 px-6 -mt-10">
              ...
              <div className="bg-white rounded-xl shadow-lg p-6 transform hover:scale-105 transition-transform duration-300">
                ...
                <div className="text-xs text-gray-500">
                  Completed on{" "}
                  {new Date(comparison.preTest.date).toLocaleDateString()}
                </div>
              </div>
                ...
                <div className="text-center">
                  {comparison.comparison.improvement > 0 ? (
                    <div className="flex items-center justify-center mb-2">
                      ...
                      <span className="text-4xl font-bold text-emerald-600 ml-2">
                        +{comparison.comparison.improvement.toFixed(1)}%
                      </span>
                    </div>
                  ) : comparison.comparison.improvement < 0 ? (
                    <div className="flex items-center justify-center mb-2">
                      ...
                      <span className="text-4xl font-bold text-rose-600 ml-2">
                        {comparison.comparison.improvement.toFixed(1)}%
                      </span>
                    </div>
                  ) : (
                    <div className="flex items-center justify-center mb-2">
                      ...
                      <span className="text-4xl font-bold text-gray-500 ml-2">
                        0%
                      </span>
                    </div>
                  )}
                  ...
                  <p className="text-sm text-gray-600 mt-2">
                    {comparison.comparison.improvementPercentage > 0
                      ...
                      : comparison.comparison.improvementPercentage < 0
                      ? `${Math.abs(
                          comparison.comparison.improvementPercentage
                        )}% decline from your initial assessment`
              ...
              <div className="bg-white rounded-xl shadow-lg p-6 transform hover:scale-105 transition-transform duration-300">
                ...
                <div className="text-xs text-gray-500">
                  Completed on{" "}
                  {new Date(comparison.postTest.date).toLocaleDateString()}
                </div>
              </div>
            </div>
        ...
        <motion.div
            ...
            <div className="mb-8 p-6 bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl border border-indigo-100">
                ...
                <div className="mt-2 ml-11">
                  {improvedCount > 0 ? (
                    <p className="text-gray-600">
                      You improved on {improvedCount} question
                      {improvedCount !== 1 ? "s" : ""}, showing good progress in
                      these areas.
                    </p>
                  ) : (
                    <p className="text-gray-600">
                      Focus on maintaining your current knowledge while
              ...
              <div className="mt-4 p-4 bg-white rounded-lg shadow-sm">
                ...
                <div className="mt-2 ml-11">
                  {declinedCount > 0 ? (
                    <p className="text-gray-600">
                      You might need additional review on {declinedCount}{" "}
                      question{declinedCount !== 1 ? "s" : ""} where your
                      performance declined.
                    </p>
                  ) : (
                    <p className="text-gray-600">
                      Great job! You maintained or improved on all questions
            ...
            <ul className="space-y-4 mt-4">
              <li className="flex items-start">
                ...
                <p className="text-gray-700">
                  ...
                  Go back to the questions where your performance declined to
              ...
              <li className="flex items-start">
                ...
                <p className="text-gray-700">
                  ...
                  Practice applying what you've learned in real-world scenarios
              ...
              <li className="flex items-start">
                ...
                <p className="text-gray-700">
                  ...
                  Discuss challenging concepts with your peers to gain new
          ...
          <div className="mt-8 p-6 bg-indigo-900 text-white rounded-xl">
            ...
            <p className="text-indigo-100 mb-4">
              Your learning journey doesn't stop here. Continue to explore and
