...
export default function CourseDetailClient({ initialCourse, initialModules, params }) {
  ...
  const [loading, setLoading] = useState(!initialCourse); // Loading hanya jika tidak ada data awal
