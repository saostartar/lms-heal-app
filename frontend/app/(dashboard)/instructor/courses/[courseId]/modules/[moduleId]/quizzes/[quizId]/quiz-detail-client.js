...
export default function QuizDetailClient({ initialQuiz, initialQuestions, params }) {
  ...
  const [loading, setLoading] = useState(!initialQuiz); // Loading hanya jika tidak ada data awal
