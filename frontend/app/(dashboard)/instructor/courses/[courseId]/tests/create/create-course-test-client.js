...
export default function CreateCourseTestClient({ initialCourseTitle, params }) {
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 py-8">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div className="space-y-1">
              ...
              <p className="text-sm text-gray-500 ml-14">
                For course: <span className="font-semibold text-primary-700">{initialCourseTitle || '...'}</span>
              </p>
            </div>
            <Link
        ...
        <div className="bg-white shadow-xl rounded-lg overflow-hidden border border-gray-100 transition-all duration-300 hover:shadow-lg">
          ...
          <CourseTestForm courseId={courseId} onError={setError} />
        </div>
